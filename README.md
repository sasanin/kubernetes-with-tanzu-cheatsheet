...
| **Dev** | <sub>Key abstractions defined<br />From code to image</sub> | <sub>Platform MVP</sub><br />[<sub>TAP install</sub>](Day%201%20-%20Design%20buildup/TAP%20install/README.md) | <sub>Golden paths?<br />Multiple dev projects in TAP</sub> | <sub>Including edge</sub> |

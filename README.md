...
The approach for the content below is simple. The *italic* Platform, Data, and App is probably what you are familiar to for traditional IT environments that is you have a platform or environment that some application is running on where a business or some end user needs in order to handle data. Always try to think in this order for this cheatsheet as it will ease the your way throughout the lifecycle. Once familiar with the basics you will be able to move on applying a more cloud native way of thinking to modern apps.

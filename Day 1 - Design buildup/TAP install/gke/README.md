...
| --- | --- | --- | --- |
| Install Google Cloud CLI | Confirm that you have a supported version (3.5 to 3.9) of Python 3 by running `python3 -V` or `python -V. <\br>Download macOS 64-bit (x86_64), (ARM64, Apple M1 silicon), or (x86) |  |  |
